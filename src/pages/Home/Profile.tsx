...
import "../Home/UI_shipper/style/profile.css";
            ...
            <div className="profile_content">
                <div className="profile_section">
                    ...
                    <div className="info_post">
                        <div className="info">
                            <h2>Introduction</h2>
                            <p>Hello, I am David McMichael. I love making websites and graphics.</p>
                            <ul>
                                <li><BriefcaseIcon className="icon_size" />Sir, P P Institute Of Science</li>
                                <li><EnvelopeIcon className="icon_size" />xyzjonathan@gmail.com</li>
                                <li><GlobeAltIcon className="icon_size" />www.xyz.com</li>
                                <li><MapPinIcon className="icon_size" />New York, USA - 100001</li>
                            </ul>
                        </div>
                        <div className="post">
                            ...
                            <div className="post_actions">
                                <div className="post_select">
                                    <button><PhotoIcon className="icon_size" /></button>
                                    <h3>Photos / Video</h3>
                                    <button className="article_btn"><DocumentTextIcon className="icon_size" /></button>
                                    <h3>Article</h3>
                                </div>
